...
Authenticates via x-functions-auth JWT (generated by Orchestra's
external engine at execution time).
"""
...
class OrchestraClient:
    ...
    def __init__(
        ...
        # Legacy: api_key still accepted for backward compat
        api_key: str | None = None,
    ):
        self.endpoint = endpoint or os.environ.get("ORCHESTRA_MCP_ENDPOINT", "")
        self.auth_token = auth_token or ""
        self.api_key = api_key or os.environ.get("ORCHESTRA_API_KEY", "")
        self.space_uid = space_uid or os.environ.get("ORCHESTRA_SPACE_UID", "")
    ...
    async def call_tool(self, tool_name: str, params: dict[str, Any]) -> Any:
        ...
        # Auth: prefer functions JWT, fall back to API key
